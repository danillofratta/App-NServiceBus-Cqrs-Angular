...
namespace Payment.Core.Domain.Application.Payment.Handlers
{
    ...
    public class ProcessPaymentHandler : Rebus.Handlers.IHandleMessages<ProcessPaymentCommand>, IHandleMessages<ProcessPaymentCommand> //IHandleMessages<ProcessPaymentEvent>
    {
